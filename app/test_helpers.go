...
func AddTestAddrs(app *TacChainApp, ctx sdk.Context, accNum int, accAmt math.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createRandomAccounts)
}

func addTestAddrs(app *TacChainApp, ctx sdk.Context, accNum int, accAmt math.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func InitAccountWithCoins(app *TacChainApp, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
...
// AddTestAddrs constructs and returns accNum amount of accounts with an
// initial balance of accAmt in random order
func AddTestAddrsIncremental(app *TacChainApp, ctx sdk.Context, accNum int, accAmt math.Int) []sdk.AccAddress {
