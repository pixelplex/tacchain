...
type BankKeeper = bankkeeper.Keeper
...
type AccountKeeper = authkeeper.AccountKeeper
...
type DistrKeeper = distrkeeper.Keeper
...
type SlashingKeeper = slashingkeeper.Keeper
